 ...
 * intricacies.
 *
 * {@link org.elasticsearch.transport.CompressibleBytesOutputStream#materializeBytes()} should be called when all the bytes have been
 ...
 *
 * {@link org.elasticsearch.transport.CompressibleBytesOutputStream#close()} will NOT close the underlying stream. The byte stream passed
