...
package com.tomgs.es.gateway.elasticsearch.node.info;
...
public class NodeInfo extends BaseNodeResponse {
    ...
    public static org.elasticsearch.action.admin.cluster.node.info.NodeInfo readNodeInfo(StreamInput in) throws IOException {
        org.elasticsearch.action.admin.cluster.node.info.NodeInfo nodeInfo = new org.elasticsearch.action.admin.cluster.node.info.NodeInfo();
