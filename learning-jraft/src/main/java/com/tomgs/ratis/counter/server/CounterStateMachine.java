...
package com.tomgs.ratis.counter.server;
...
public class CounterStateMachine extends BaseStateMachine {
  ...
  public CounterStateMachine(CounterServer counterServer) {
  ...
  public CompletableFuture<Message> query(Message request) {
    ...
    RaftServer.Division division = counterServer.getDivision();
    DivisionInfo info = division.getInfo();
    RaftProtos.RaftPeerRole currentRole = info.getCurrentRole();
