...
package com.tomgs.ratis.election;
 ...
 */
public final class ElectionServer implements Closeable {
  private final RaftServer server;
  private final RaftServer.Division division;

  public ElectionServer(RaftPeer peer, File storageDir) throws IOException {
    ...
    ElectionStateMachine electionStateMachine = new ElectionStateMachine();
    ...
    this.server = RaftServer.newBuilder()
        ...
        .setStateMachine(electionStateMachine)
  ...
  public static void main(String[] args) throws IOException {
    ...
    final ElectionServer electionServer = new ElectionServer(currentPeer, storageDir);
    electionServer.start();

    //exit when any input entered
    Scanner scanner = new Scanner(System.in, UTF_8.name());
    scanner.nextLine();
    electionServer.close();
  }
}
