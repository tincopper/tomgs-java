...
public interface WatchRaftClient extends Closeable {
    ...
    static WatchRaftClient.Builder newBuilder() {
        return new WatchRaftClient.Builder();
    }
    ...
    class Builder {
        ...
        public WatchRaftClient.Builder setClientId(ClientId clientId) {
            this.clientId = clientId;
            return this;
        }

        /** Set servers. */
        public WatchRaftClient.Builder setRaftGroup(RaftGroup grp) {
            this.group = grp;
            return this;
        }

        /** Set leader ID. */
        public WatchRaftClient.Builder setLeaderId(RaftPeerId leaderId) {
            this.leaderId = leaderId;
            return this;
        }

        /** Set primary server of DataStream. */
        public WatchRaftClient.Builder setPrimaryDataStreamServer(RaftPeer primaryDataStreamServer) {
            this.primaryDataStreamServer = primaryDataStreamServer;
            return this;
        }

        /** Set {@link RaftClientRpc}. */
        public WatchRaftClient.Builder setClientRpc(RaftClientRpc clientRpc) {
            this.clientRpc = clientRpc;
            return this;
        }

        /** Set {@link RaftProperties}. */
        public WatchRaftClient.Builder setProperties(RaftProperties properties) {
            this.properties = properties;
            return this;
        }

        /** Set {@link Parameters}. */
        public WatchRaftClient.Builder setParameters(Parameters parameters) {
            this.parameters = parameters;
            return this;
        }

        /** Set {@link RetryPolicy}. */
        public WatchRaftClient.Builder setRetryPolicy(RetryPolicy retryPolicy) {
