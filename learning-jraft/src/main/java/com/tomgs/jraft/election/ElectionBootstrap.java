 ...
 */
package com.tomgs.jraft.election;
...
public class ElectionBootstrap {
    ...
    public static void main(final String[] args) {
        if (args.length < 4) {
            System.out
                .println("Useage : java ElectionBootstrap {dataPath} {groupId} {serverId} {initConf}");
            System.out
                .println("Example: java ElectionBootstrap /tmp/server1 election_test 127.0.0.1:8081 127.0.0.1:8081,127.0.0.1:8082,127.0.0.1:8083");
            System.exit(1);
        }
