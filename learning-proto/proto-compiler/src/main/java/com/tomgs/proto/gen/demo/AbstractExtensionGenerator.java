...
public abstract class AbstractExtensionGenerator extends Generator {
    ...
    private MethodContext buildMethodContext(MethodDescriptorProto methodProto, ProtoTypeMap typeMap, List<Location> locations, int methodNumber) {
        ...
        if (dubboRule != null) {
            ...
            dubboRuleContext.methodName = dubboRule.getMethodName();
            dubboRuleContext.serviceName = dubboRule.getServiceName();
            methodContext.dubboRule = dubboRuleContext;
        }
    ...
    private class MethodContext {
        ...
        public String javaDoc;
        public DubboRuleContext dubboRule;
