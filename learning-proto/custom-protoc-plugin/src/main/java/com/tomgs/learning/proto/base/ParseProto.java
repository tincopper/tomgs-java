...
public class ParseProto {
    ...
    //public final String PROTO_FILE_DIR = System.getProperty("user.dir") + "/protoFile/";	// proto文件所在文件夹
    public final String PROTOC_DIR = "protoc.exe";
    public final String PROTO_FILE_DIR = System.getProperty("user.dir") + "/src/main/proto/";
    ...
    public String genProtoDesc(String protoName) throws Exception {
        ...
        cmd.append(" -I=").append(this.PROTO_FILE_DIR).append(" --descriptor_set_out=").append(descFileDir).append(" ").append(this.PROTO_FILE_DIR).append(protoName);
     ...
     * @throws Exception
     */
    public void genJavaSource(String protoName) throws Exception {
        // 目标文件名
        // 命令： cmd /c protoc.exe -IE:\workspace\tomgs-java\learning-proto\custom-protoc-plugin/src/main/proto/ --java_out=E:\workspace\tomgs-java\learning-proto\custom-protoc-plugin\target\generated-sources\protobuf/java cinema.proto
        StringBuffer cmd = new StringBuffer();
        cmd.append("cmd /c ");
        cmd.append(PROTOC_DIR);
        cmd.append(" --java_out=").append(this.PROTO_FILE_DIR).append(" ").append(this.PROTO_FILE_DIR).append(protoName);

        String failMsg = "生成java文件命令执行失败!";
        execCommand(cmd.toString(), "生成java文件", failMsg);
    }
